...
public:
	void init() {
		...
		scale.setup("", XOR("hitbox_scale"), 1.f, 100.f, false, 0, 90.f, 1.f);
		scale.AddShowCallback(callbacks::IsMultipointOn);
		RegisterElement(&scale);

		body_scale.setup(XOR("body hitbox scale"), XOR("body_hitbox_scale"), 1.f, 100.f, true, 0, 50.f, 1.f);
		body_scale.AddShowCallback(callbacks::IsMultipointBodyOn);
		RegisterElement(&body_scale);

		minimal_damage.setup(XOR("minimal damage"), XOR("minimal_damage"), 1.f, 125.f, true, 0, 40.f, 1.f);
		RegisterElement(&minimal_damage);

		penetrate_minimal_damage.setup("", XOR("penetrate_minimal_damage"), 1.f, 125.f, false, 0, 30.f, 1.f);
		...
		damage_override_value.setup("", XOR("damage_override_value"), 1.f, 125.f, false, 0, 1.f, 1.f);
...
public:
	void init() {
		...
		walk_speed.setup("walk speed trigger", XOR("walk_speed"), 1.f, 145.f, true, 0, 1.f, 1.f);
...
public:
	void init() {
		...
		tracers.setup(XOR("grenade tracers"), XOR("tracers"));
		...
		viewmodel_fov_amt.AddShowCallback(callbacks::IsViewmodelOn);
...
public:
	void init() {
		...
		secondary.setup(XOR("secondary"), XOR("secondary"), { XOR("off"), XOR("light pistol"), XOR("heavy pistol"), XOR("elite") });
